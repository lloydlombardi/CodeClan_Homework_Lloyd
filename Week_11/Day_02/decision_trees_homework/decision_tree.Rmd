...
titanic_clean <- titanic_set %>% 
  ...
  drop_na()
```
The cleaning steps above had to be changed in the following ways:

* bring the `select` step above the `drop_na()` step
* data set goes from 150 rows to 712 rows
...
** RESULTS BEFORE CHANGING `drop_na() STEP **
* Of 147 people
  + 100 survived
  + 47 died
...
** RESULTS AFTER CHANGING `drop_na()` in cleaning step **
...
* correctly predicted 9 deaths
* correctly predicted 16 survivals
* incorrectly predicted 7 deaths
* incorrectly predicted 4 survivals
* accuracy rating of 0.6944
* sensitivity (TPR) of 0.6923
* specificity (FPR) of 0.6957


** RESULTS AFTER CHANGING `drop_na() STEP **
The model has:

* correctly predicted 72 deaths
* correctly predicted 41 survivals
* incorrectly predicted 14 deaths
* incorrectly predicted 15 survivals
* accuracy rating of 0.6944
* sensitivity (TPR) of 0.8372
* specificity (FPR) of 0.7321
